...
bind '"c":clear' # when the c key is pressed, o will be output
...
bind '"l":"v"' # when the l key is pressed, f will be output
bind '"m":"j"' # when the m key is pressed, q will be output
# bind '"n":";"' # when the n key is pressed, ; will be output
bind '"o":"x"' # when the o key is pressed, d will be output
...
bind '"u":"k"' # when the u key is pressed, c will be output
...
# bind '" ":"h"' # when the " " key is pressed, v will be output
# bind '".":"g"' # when the . key is pressed, h will be output
bind '"/":"z"' # when the / key is pressed, r will be output
